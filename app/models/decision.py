...
from sqlalchemy import String, Text, Numeric, Integer, DateTime, ForeignKey, Uuid
...
class Decision(Base):
    ...
    prompt_tokens: Mapped[int] = mapped_column(
        Integer, nullable=False, default=0, comment="Tokens sent to the LLM"
    )
    completion_tokens: Mapped[int] = mapped_column(
        Integer, nullable=False, default=0, comment="Tokens generated by the LLM"
    )
    total_tokens: Mapped[int] = mapped_column(
        Integer, nullable=False, default=0, comment="Total OpenAI tokens for this decision"
    )
